...
<title>Atomik Controller - Add Remote</title>
...
// Atomik Setting SQL
$sql = "SELECT atomik_remote_types.remote_type_name, atomik_remote_types.remote_type_id FROM atomik_remote_types;";  
...
<hr>
  ...
  <div class="container">
        ...
        <div class="col-xs-8">
  <form id="chooseremfrm" name="chooseremfrm" action="device_details.php" method="post"><input name="new" id="new" type="hidden" value="1"><table class="table table-striped">
  <thead>
    <tr>
        <td>
