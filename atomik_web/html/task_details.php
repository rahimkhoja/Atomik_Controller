...
{	
	...
	if ($_new_task == 1 )
	{
		...
		if ( $_task_zone == $row['task_zone_id'] && $_task_status == $row['task_status'] && $_task_colormode == $row['task_colormode'] && $_task_brightness == $row['task_brightness'] && $_task_rgb256 == $row['task_rgb256'] && $_task_white_temprature == $row['task_white_temprature'] ) {
			array_push($erro, "No Changes To Save");
		} else {
