...
if ($_device_white_temprature <= 3080) {
  $_device_white_temprature = 3080;
}
else
if ($_device_white_temprature <= 3460) {
  $_device_white_temprature = 3460;
}
else
if ($_device_white_temprature <= 3840) {
  $_device_white_temprature = 3840;
}
else
if ($_device_white_temprature <= 4220) {
  $_device_white_temprature = 4220;
}
else
if ($_device_white_temprature <= 4600) {
  $_device_white_temprature = 4600;
}
else
if ($_device_white_temprature <= 4980) {
  $_device_white_temprature = 4980;
}
else
if ($_device_white_temprature <= 5360) {
  $_device_white_temprature = 5360;
}
else
if ($_device_white_temprature <= 5740) {
  $_device_white_temprature = 5740;
}
else
if ($_device_white_temprature <= 6120) {
  $_device_white_temprature = 6120;
}
else
if ($_device_white_temprature <= 6500) {
...
if ($_device_type_warm_white == 1 && $_device_type_cold_white == 1) {
  ...
  if ($_device_brightness <= 18) {
    $_device_brightness = 18;
  }
  else
  if ($_device_brightness <= 27) {
    $_device_brightness = 27;
  }
  else
  if ($_device_brightness <= 36) {
    $_device_brightness = 36;
  }
  else
  if ($_device_brightness <= 45) {
    $_device_brightness = 45;
  }
  else
  if ($_device_brightness <= 54) {
    $_device_brightness = 54;
  }
  else
  if ($_device_brightness <= 63) {
    $_device_brightness = 63;
  }
  else
  if ($_device_brightness <= 72) {
    $_device_brightness = 72;
  }
  else
  if ($_device_brightness <= 81) {
    $_device_brightness = 81;
  }
  else
  if ($_device_brightness <= 90) {
    $_device_brightness = 90;
  }
  else
  if ($_device_brightness <= 100) {
  ...
  if ($_device_brightness <= 8) {
    $_device_brightness = 8;
  }
  else
  if ($_device_brightness <= 12) {
    $_device_brightness = 12;
  }
  else
  if ($_device_brightness <= 15) {
    $_device_brightness = 15;
  }
  else
  if ($_device_brightness <= 19) {
    $_device_brightness = 19;
  }
  else
  if ($_device_brightness <= 23) {
  ...
  if ($_device_brightness <= 31) {
    $_device_brightness = 31;
  }
  else
  if ($_device_brightness <= 35) {
    $_device_brightness = 35;
  }
  else
  if ($_device_brightness <= 39) {
    $_device_brightness = 39;
  }
  else
  if ($_device_brightness <= 42) {
    $_device_brightness = 42;
  }
  else
  if ($_device_brightness <= 46) {
    $_device_brightness = 46;
  }
  else
  if ($_device_brightness <= 50) {
  ...
  if ($_device_brightness <= 58) {
    $_device_brightness = 58;
  }
  else
  if ($_device_brightness <= 62) {
    $_device_brightness = 62;
  }
  else
  if ($_device_brightness <= 65) {
    $_device_brightness = 65;
  }
  else
  if ($_device_brightness <= 69) {
    $_device_brightness = 69;
  }
  else
  if ($_device_brightness <= 73) {
    $_device_brightness = 73;
  }
  else
  if ($_device_brightness <= 77) {
  ...
  if ($_device_brightness <= 85) {
    $_device_brightness = 85;
  }
  else
  if ($_device_brightness <= 88) {
    $_device_brightness = 88;
  }
  else
  if ($_device_brightness <= 92) {
    $_device_brightness = 92;
  }
  else
  if ($_device_brightness <= 96) {
...
if ($command <> "" && $command != "" && $command == "save_properties") {
  ...
  if (count($erro) > 0) {
    ...
    $_device_transmission = transmit($_device_brightness, $row['device_brightness'], $_device_status, $row['device_status'], $_device_rgb256, $row['device_rgb256'], $_device_white_temprature, $row['device_white_temprature'], $_device_colormode, $row['device_colormode'], $_device_address1, $_device_address2, $_device_transmission, $_device_type_rgb256, $_device_type_warm_white, $_device_type_cold_white);
    $sql = "UPDATE atomik_devices SET device_status = " . trim($_device_status) . ", device_colormode = " . trim($_device_colormode) . ", device_brightness = " . trim($_device_brightness) . ", device_rgb256 = " . trim($_device_rgb256) . ", device_white_temprature = " . trim($_device_white_temprature) . ", device_transmission = " . trim($_device_transmission) . " WHERE device_id=" . $_device_id . ";";
    if ($conn->query($sql) === TRUE) {
      $page_success = 1;
