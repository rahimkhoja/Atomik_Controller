...
<div class="container center-block">
    <div class="col-xs-2"></div>
        <div class="col-xs-4">
           <h4><p>Zones List:</p></h4></div><div class="col-xs-4 text-right"><p><strong>Total Zones: 11</strong></p><p><a href="" class="btn-primary btn">Add New Zone</a></p>  </div>
           <div class="col-xs-2"></div>
           </div><br>
           <div class="container center-block">
    <div class="col-xs-2"></div>
  ...
  <table class="table table-striped">
    ...
    <div class="col-xs-2"></div>
        <div class="col-xs-4">
           </div><div class="col-xs-4 text-right"><p><strong>Total Zones: 11</strong></p><p><a href="" class="btn-primary btn">Add New Zone</a></p>  </div>
           <div class="col-xs-2"></div>
           </div><br>
